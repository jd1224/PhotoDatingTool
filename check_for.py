...
def welcome():
	...
	typewrite('************************|--------------------------|**************Created by**\n')
	typewrite('**************************Press any key to continue***************by*joshc1224\n')
	input('******************************************************************************\n')
def about():
	os.system('cls')
...
def help():
	...
	print('\njoshc1224@yahoo.com with a detailed description of the porblem, and screenshots if available')
	input('Press Enter to Continue')
